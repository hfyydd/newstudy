...
/// 从YouTube创建笔记页面
class CreateNoteFromYoutubePage extends GetView<CreateNoteFromYoutubeController> {
  const CreateNoteFromYoutubePage({super.key});
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '请输入或粘贴YouTube视频地址，系统将获取视频字幕并生成笔记',
                            style: TextStyle(
                              fontSize: 13,
